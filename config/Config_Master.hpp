...
/* System Settings */
    ...
    news_broadcast_cost = 1500; //Cost for a player to send a news station broadcast.
    ...
    gang_price = 10000000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
