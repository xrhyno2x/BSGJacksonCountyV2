...
_pgText ctrlSetText format["Working at Murder King, stay close (15m) (%1%2)...",round(_cP * 100),"%"];
...
[[1,format["Murder King is now closed", _shop, _robber, [_kassa] call life_fnc_numberText]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
life_use_atm = true;
