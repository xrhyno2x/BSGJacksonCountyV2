...
if(side _robber != civilian) exitWith { hint "You can not rob this garage!" };
...
[[2,"<> LAKESIDE DEALS ON WHEELS IS BEING ROBBED<>!!! $$$"],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
...
sleep 300;
_action = _shop addAction["Rob the car shop",life_fnc_robcarshop];
_shop switchMove "";